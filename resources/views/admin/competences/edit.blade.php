                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-warning text-dark">
                        <h4 class="mb-0">
                            ...
                            Edit Kompetensi Dosen
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.competences.update', $competence) }}" method="POST" id="competenceEditForm">
                            @csrf
                            @method('PUT')
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" 
                                                           value="{{ $competence->dosen->nama_lengkap }} ({{ $competence->dosen->nidn_nip }})" 
                                                           readonly>
                                                    <input type="hidden" name="dosen_id" value="{{ $competence->dosen_id }}">
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="status_sertifikasi" id="status_sertifikasi" class="form-select @error('status_sertifikasi') is-invalid @enderror" required>
                                                        ...
                                                        @foreach(\App\Models\Competence::getStatusSertifikasiOptions() as $value => $label)
                                                            <option value="{{ $value }}" {{ old('status_sertifikasi', $competence->status_sertifikasi) == $value ? 'selected' : '' }}>
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="metodologi_pengajaran" id="metodologi_pengajaran" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan metodologi dan strategi pengajaran yang dikuasai...">{{ old('metodologi_pengajaran', $competence->metodologi_pengajaran) }}</textarea>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="teknik_evaluasi" id="teknik_evaluasi" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan teknik evaluasi dan penilaian pembelajaran...">{{ old('teknik_evaluasi', $competence->teknik_evaluasi) }}</textarea>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="manajemen_kelas" id="manajemen_kelas" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan kemampuan manajemen dan pengelolaan kelas...">{{ old('manajemen_kelas', $competence->manajemen_kelas) }}</textarea>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="teknologi_pembelajaran" id="teknologi_pembelajaran" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan penggunaan teknologi dalam pembelajaran...">{{ old('teknologi_pembelajaran', $competence->teknologi_pembelajaran) }}</textarea>
                                                ...
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <textarea name="pengembangan_kurikulum" id="pengembangan_kurikulum" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan kemampuan pengembangan dan adaptasi kurikulum...">{{ old('pengembangan_kurikulum', $competence->pengembangan_kurikulum) }}</textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="keahlian_bidang" id="keahlian_bidang" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan keahlian khusus dalam bidang ilmu...">{{ old('keahlian_bidang', $competence->keahlian_bidang) }}</textarea>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="penelitian_terapan" id="penelitian_terapan" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan kemampuan penelitian terapan di bidangnya...">{{ old('penelitian_terapan', $competence->penelitian_terapan) }}</textarea>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="publikasi_ilmiah" id="publikasi_ilmiah" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan publikasi dan karya ilmiah yang dihasilkan...">{{ old('publikasi_ilmiah', $competence->publikasi_ilmiah) }}</textarea>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="kolaborasi_industri" id="kolaborasi_industri" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan kolaborasi dengan industri dan praktisi...">{{ old('kolaborasi_industri', $competence->kolaborasi_industri) }}</textarea>
                                                ...
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <textarea name="update_pengetahuan" id="update_pengetahuan" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan upaya pembaruan pengetahuan dan kompetensi...">{{ old('update_pengetahuan', $competence->update_pengetahuan) }}</textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="komunikasi_efektif" id="komunikasi_efektif" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan kemampuan komunikasi dengan mahasiswa dan kolega...">{{ old('komunikasi_efektif', $competence->komunikasi_efektif) }}</textarea>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="kerjasama_tim" id="kerjasama_tim" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan kemampuan bekerja dalam tim dan kolaborasi...">{{ old('kerjasama_tim', $competence->kerjasama_tim) }}</textarea>
                                                    @error('kerjasama_tim')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="kepemimpinan" id="kepemimpinan" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan kemampuan kepemimpinan dan pengembangan orang lain...">{{ old('kepemimpinan', $competence->kepemimpinan) }}</textarea>
                                                    @error('kepemimpinan')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="adaptasi_budaya" id="adaptasi_budaya" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan kemampuan adaptasi dengan beragam budaya...">{{ old('adaptasi_budaya', $competence->adaptasi_budaya) }}</textarea>
                                                ...
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <textarea name="etika_profesi" id="etika_profesi" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan pemahaman dan penerapan etika profesi...">{{ old('etika_profesi', $competence->etika_profesi) }}</textarea>
                                                    @error('etika_profesi')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="sertifikat_pendidik" id="sertifikat_pendidik" 
                                                           ...
                                                           placeholder="Nomor/Nama sertifikat pendidik..." 
                                                           value="{{ old('sertifikat_pendidik', $competence->sertifikat_pendidik) }}">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="date" name="tanggal_sertifikat" id="tanggal_sertifikat" 
                                                           ...
                                                           value="{{ old('tanggal_sertifikat', $competence->tanggal_sertifikat ? $competence->tanggal_sertifikat->format('Y-m-d') : '') }}">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="sertifikasi_lain" id="sertifikasi_lain" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan sertifikasi profesional lainnya...">{{ old('sertifikasi_lain', $competence->sertifikasi_lain) }}</textarea>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea name="pelatihan_kompetensi" id="pelatihan_kompetensi" 
                                                              ...
                                                              rows="3" placeholder="Deskripsikan pelatihan kompetensi yang pernah diikuti...">{{ old('pelatihan_kompetensi', $competence->pelatihan_kompetensi) }}</textarea>
                                ...
                                <div class="col-12">
                                    <div class="d-flex gap-2 justify-content-end">
                                        <button type="submit" class="btn btn-warning">
                                            <i class="fas fa-save me-2"></i>Update Kompetensi
                                        </button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const form = document.getElementById('competenceEditForm');
