...
@section('title', 'Tambah Kualifikasi Dosen')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">Tambah Kualifikasi Dosen</h1>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h5 class="card-title mb-0">
                ...
                Form Kualifikasi Dosen
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('admin.qualifications.store') }}" method="POST" id="qualificationForm">
                @csrf
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select name="jenjang_pendidikan" id="jenjang_pendidikan" 
                                ...
                                @foreach(\App\Models\Qualification::getJenjangPendidikanOptions() as $value => $label)
                                    <option value="{{ $value }}" {{ old('jenjang_pendidikan') == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="status_pt" id="status_pt" 
                                ...
                                @foreach(\App\Models\Qualification::getStatusPTOptions() as $value => $label)
                                    <option value="{{ $value }}" {{ old('status_pt') == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="akreditasi_pt" id="akreditasi_pt" 
                                ...
                                @foreach(\App\Models\Qualification::getAkreditasiPTOptions() as $value => $label)
                                    <option value="{{ $value }}" {{ old('akreditasi_pt') == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="ipk" id="ipk" 
                                   ...
                                   value="{{ old('ipk') }}" step="0.01" min="0" max="4"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="tahun_lulus" id="tahun_lulus" 
                                   ...
                                   value="{{ old('tahun_lulus') }}" min="1950" max="{{ date('Y') + 5 }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status_kelulusan" id="status_kelulusan" 
                                ...
                                @foreach(\App\Models\Qualification::getStatusKelulusanOptions() as $value => $label)
                                    <option value="{{ $value }}" {{ old('status_kelulusan', 'Lulus') == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="riwayat_pendidikan" id="riwayat_pendidikan" 
                                      ...
                                      rows="3" placeholder="Deskripsi tambahan mengenai riwayat pendidikan">{{ old('riwayat_pendidikan') }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="jabatan_fungsional" id="jabatan_fungsional" 
                                ...
                                @foreach(\App\Models\Qualification::getJabatanFungsionalOptions() as $value => $label)
                                    <option value="{{ $value }}" {{ old('jabatan_fungsional') == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nomor_sertifikat_pendidik" id="nomor_sertifikat_pendidik" 
                                   ...
                                   value="{{ old('nomor_sertifikat_pendidik') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="tahun_sertifikasi" id="tahun_sertifikasi" 
                                   ...
                                   value="{{ old('tahun_sertifikasi') }}" min="2000" max="{{ date('Y') }}"
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="bidang_penelitian_utama" id="bidang_penelitian_utama" 
                                   ...
                                   value="{{ old('bidang_penelitian_utama') }}"
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="publikasi_scopus" id="publikasi_scopus" 
                                   ...
                                   value="{{ old('publikasi_scopus') }}" min="0"
                                   placeholder="0">
