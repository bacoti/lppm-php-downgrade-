        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.researches.update', $research) }}" method="POST" enctype="multipart/form-data" id="researchForm">
                            @csrf
                            @method('PUT')
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="judul" id="judul"
                                                           ...
                                                           value="{{ old('judul', $research->judul) }}" required>
                                                    @error('judul')
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="dosen_id" id="dosen_id" class="form-select @error('dosen_id') is-invalid @enderror">
                                                        ...
                                                        @foreach($dosens as $dosen)
                                                            <option value="{{ $dosen->id }}" {{ old('dosen_id', $research->dosen_id) == $dosen->id ? 'selected' : '' }}>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="bidang" id="bidang"
                                                           ...
                                                           value="{{ old('bidang', $research->bidang) }}" placeholder="Contoh: Informatika, Biologi, dll">
                                                    @error('bidang')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="tahun" id="tahun"
                                                           ...
                                                           value="{{ old('tahun', $research->tahun) }}" min="2000" max="{{ date('Y') + 1 }}">
                                                    @error('tahun')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="nidn_leader" id="nidn_leader"
                                                           ...
                                                           value="{{ old('nidn_leader', $research->nidn_leader) }}" placeholder="Masukkan NIDN leader">
                                                    @error('nidn_leader')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="leader_name" id="leader_name"
                                                           ...
                                                           value="{{ old('leader_name', $research->leader_name) }}" placeholder="Masukkan nama leader">
                                                    @error('leader_name')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="pddikti_code_pt" id="pddikti_code_pt"
                                                           ...
                                                           value="{{ old('pddikti_code_pt', $research->pddikti_code_pt) }}" placeholder="Masukkan kode PT PDDIKTI">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="institution" id="institution"
                                                           ...
                                                           value="{{ old('institution', $research->institution) }}" placeholder="Masukkan nama institusi">
                                                    @error('institution')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="skema_abbreviation" id="skema_abbreviation"
                                                           ...
                                                           value="{{ old('skema_abbreviation', $research->skema_abbreviation) }}" placeholder="Contoh: PDUPT, PD, dll">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="skema_name" id="skema_name"
                                                           ...
                                                           value="{{ old('skema_name', $research->skema_name) }}" placeholder="Nama lengkap skema">
                                                    @error('skema_name')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="number" name="first_proposal_year" id="first_proposal_year"
                                                           ...
                                                           value="{{ old('first_proposal_year', $research->first_proposal_year) }}" min="2000" max="{{ date('Y') + 10 }}">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="number" name="proposed_year_of_activities" id="proposed_year_of_activities"
                                                           ...
                                                           value="{{ old('proposed_year_of_activities', $research->proposed_year_of_activities) }}" min="2000" max="{{ date('Y') + 10 }}">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="number" name="year_of_activity" id="year_of_activity"
                                                           ...
                                                           value="{{ old('year_of_activity', $research->year_of_activity) }}" min="2000" max="{{ date('Y') + 10 }}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="proposal_status" id="proposal_status" class="form-select @error('proposal_status') is-invalid @enderror">
                                                        ...
                                                        @foreach(\App\Models\Research::getProposalStatusOptions() as $value => $label)
                                                            <option value="{{ $value }}" {{ old('proposal_status', $research->proposal_status) == $value ? 'selected' : '' }}>
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="duration_of_activity" id="duration_of_activity"
                                                           ...
                                                           value="{{ old('duration_of_activity', $research->duration_of_activity) }}" min="1" max="10">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="target_tkt_level" id="target_tkt_level"
                                                           ...
                                                           value="{{ old('target_tkt_level', $research->target_tkt_level) }}" min="1" max="9">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="hibah_program" id="hibah_program"
                                                           ...
                                                           value="{{ old('hibah_program', $research->hibah_program) }}" placeholder="Contoh: PDUPT, PD, dll">
                                                    @error('hibah_program')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="focus_area" id="focus_area"
                                                           ...
                                                           value="{{ old('focus_area', $research->focus_area) }}" placeholder="Area fokus penelitian">
                                                    @error('focus_area')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                                                        ...
                                                        @foreach(\App\Models\Research::getStatusOptions() as $value => $label)
                                                            <option value="{{ $value }}" {{ old('status', $research->status) == $value ? 'selected' : '' }}>
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <select name="kategori" id="kategori" class="form-select @error('kategori') is-invalid @enderror">
                                                        ...
                                                        @foreach(\App\Models\Research::getKategoriOptions() as $value => $label)
                                                            <option value="{{ $value }}" {{ old('kategori', $research->kategori) == $value ? 'selected' : '' }}>
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <select name="tingkat" id="tingkat" class="form-select @error('tingkat') is-invalid @enderror">
                                                        ...
                                                        @foreach(\App\Models\Research::getTingkatOptions() as $value => $label)
                                                            <option value="{{ $value }}" {{ old('tingkat', $research->tingkat) == $value ? 'selected' : '' }}>
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="number" name="progress_percentage" id="progress_percentage"
                                                           ...
                                                           value="{{ old('progress_percentage', $research->progress_percentage) }}" min="0" max="100">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-check">
                                                        <input type="checkbox" name="hibah_kompetitif" id="hibah_kompetitif"
                                                               ...
                                                               value="1" {{ old('hibah_kompetitif', $research->hibah_kompetitif) ? 'checked' : '' }}>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="sumber_dana" id="sumber_dana"
                                                           ...
                                                           value="{{ old('sumber_dana', $research->sumber_dana) }}" placeholder="Contoh: DIKTI, Mandiri, dll">
                                                    @error('sumber_dana')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="jumlah_dana" id="jumlah_dana"
                                                           ...
                                                           value="{{ old('jumlah_dana', $research->jumlah_dana) }}" min="0" step="1000"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="funds_approved" id="funds_approved"
                                                           ...
                                                           value="{{ old('funds_approved', $research->funds_approved) }}" min="0" step="1000"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="funds_institution" id="funds_institution"
                                                           ...
                                                           value="{{ old('funds_institution', $research->funds_institution) }}" placeholder="Institusi pemberi dana">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="sinta_affiliation_id" id="sinta_affiliation_id"
                                                           ...
                                                           value="{{ old('sinta_affiliation_id', $research->sinta_affiliation_id) }}" placeholder="ID afiliasi SINTA">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="fund_source_category" id="fund_source_category"
                                                           ...
                                                           value="{{ old('fund_source_category', $research->fund_source_category) }}" placeholder="Kategori sumber dana">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="fund_source" id="fund_source"
                                                           ...
                                                           value="{{ old('fund_source', $research->fund_source) }}" placeholder="Sumber dana spesifik">
                                                    @error('fund_source')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="country_fund_source" id="country_fund_source"
                                                           ...
                                                           value="{{ old('country_fund_source', $research->country_fund_source ?? 'Indonesia') }}" placeholder="Negara sumber dana">
                                            ...
                                            <div class="row">
                                                <div class="col-12 mb-3">
                                                    <textarea name="abstrak" id="abstrak" rows="5"
                                                              ...
                                                              placeholder="Jelaskan abstrak penelitian secara singkat dan jelas...">{{ old('abstrak', $research->abstrak) }}</textarea>
                                                    @error('abstrak')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex gap-2 justify-content-end">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-2"></i>Update Penelitian
                                        </button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Format number input for funds_are_approved
        const fundsApprovedInput = document.getElementById('funds_approved');
        if (fundsApprovedInput) {
            fundsApprovedInput.addEventListener('input', function() {
                // Remove non-numeric characters except decimal point
                this.value = this.value.replace(/[^\d.]/g, '');
            });
        }
